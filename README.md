<p align="center">
    ...
    <h1 align="center">Legodb : A low-code backend tool for every ship-fast project</h1>
</p>

Legodb is an open-source, simple, and flexible go-to backend solution for all your ship-fast projects. It seamlessly integrates with dashboards, drawing inspiration from the UX/UI of Notion's inline databases and Discord's server and channel system.

It allows you to easily structure your application database in a visual way with an intuitive UX. The dashboard and API are automatically generated based on your designed database structure.
