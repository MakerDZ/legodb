        ...
        <div className="pointer-events-none fixed bottom-0 left-0 -z-10 select-none blur-3xl">
            ...
            >
                ...
                <defs>
                    ...
                    >
                        <stop stopColor="#B1E3FF"></stop>
                        <stop offset="0.5" stopColor="#E9D984"></stop>
                        <stop offset="1" stopColor="#FF9A61"></stop>
                    </linearGradient>
                </defs>
            </svg>
            <svg
            ...
            >
                ...
                <defs>
                    <linearGradient
                        ...
                        gradientUnits="userSpaceOnUse"
                    >
                        <stop stopColor="#3300FF"></stop>
                        <stop offset="0.5" stopColor="#52E4FF"></stop>
                        <stop offset="1" stopColor="#56D7FF"></stop>
                    </linearGradient>
                </defs>
            </svg>
        </div>
